...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { content: @slide.content, image: @slide.image, section_id: @slide.section_id, title: @slide.title }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { content: @slide.content, image: @slide.image, section_id: @slide.section_id, title: @slide.title }
    assert_redirected_to slide_path(assigns(:slide))
  end
